...
export default function LoginPage() {
  ...
  const handleTelegramLogin = async () => {
    try {
      ...
      tg.ready(); // ⬅️ مهم جداً لتفعيل الواجهة
      ...
      console.log('✅ مستخدم تيليجرام:', tgUser);
  ...
  useEffect(() => {
    if (window?.Telegram?.WebApp) {
      window.Telegram.WebApp.ready(); // ⬅️ ضروري لتفعيل السياق
    }
  }, []);
        ...
        <div className="card mb-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <button onClick={handleTelegramLogin} className="primary-button w-full flex items-center justify-center gap-2">
