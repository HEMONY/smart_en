...
export default function Dashboard() {
  ...
  const [globalCountdown, setGlobalCountdown] = useState({ days: 0, hours: 0, minutes: 0, seconds: 0 });
  ...
  useEffect(() => {
    ...
    // ⏳ عداد العرض العالمي (43 يوم من 2025-07-20)
    const offerEnd = new Date('2025-09-01T00:00:00');
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="p-4 text-center text-yellow-400">
        ينتهي العرض خلال: {globalCountdown.days} يوم، {globalCountdown.hours} ساعة، {globalCountdown.minutes} دقيقة، {globalCountdown.seconds} ثانية
      </div>
      ...
      <footer className="text-xs text-center text-gray-400 p-4 mt-8">
        بالتسجيل، أنت توافق على{' '}
        <Link href="/term" className="text-primary-gold underline">شروط الاستخدام</Link> و{' '}
        <Link href="/privacy" className="text-primary-gold underline">سياسة الخصوصية</Link>
      </footer>
